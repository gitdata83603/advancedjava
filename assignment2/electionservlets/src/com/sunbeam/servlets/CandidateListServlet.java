...
public class CandidateListServlet extends HttpServlet 
{
	...
	protected void processRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
		...
		}// name='candidate'   will be key    and    value=%d  --> %d =id (value)
		//when user selects any of the radio button and hit the vote(submit) button the data transfer will take place in key-value pair
		//(key,value) = (candidate,id(1 or 2 or .....))  ---> to "vote" servlet
